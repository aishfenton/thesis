...
% Image functions
%
\newcommand{\pic}[3]{\begin{figure}[htbp]\begin{center}\includegraphics[scale=1.0]%
	{#1}\caption{#2}\label{#3}\end{center}\end{figure}}

\newcommand{\picscl}[4]{\begin{figure}[htbp]\begin{center}\includegraphics[scale=#4]%
	{#1}\caption{#2}\label{#3}\end{center}\end{figure}}
