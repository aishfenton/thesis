...
\picscl{images/nn.pdf}{An example of the Nearest Neighbour method being applied. A partially constructed route selects customer $j$ to add, as it's closest to the last added customer, $i$}{fig:nn}{0.55}
...
\picscl{images/sweep.pdf}{Sweep Algorithm. The ray is being swept clickwise. One route has already been formed, and a second is about to start at customer $i$}{fig:sweep}{0.55}
...
\picscl{images/search_space.pdf}{Search space with a rough terrain}{fig:rtst}{0.66}
