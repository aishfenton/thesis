...
\picscl{images/comparision.pdf}{Shown are the average results across all problem instances obtained by the Enhanced Bees Algorithm (shown in red) mapped against the results listed in Table~\ref{tab:resultscomparison}.}{fig:resultscomparison}{1.0}
