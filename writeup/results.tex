...
Table \ref{tab:standard_results} summarises these results.
...
\picscl{images/lns_1s1p_blowup.pdf}{Shown are the same results as are depicted in \ref{fig:lns}, but with the area between 0.8 and 1.0 of the left axis blown up.}{fig:lns_blowup}{1.1}
...
\ctable[caption=Experiment Results Summary, label=tab:results_summary, pos=h, botcap, framesep=10pt]
...
\ctable[caption=Results Comparison, label=tab:resultscomparison, botcap, framesep=10pt, sideways, doinside=\small]
{lrrrrrrrrr}
{
